...
file.remove(gsub('processed_data/lines.rds', 'src/json/lines.geojson', tail(.args, 1)))

st_write(lines, gsub('processed_data/lines.rds', 'src/json/lines.geojson', tail(.args, 1)))

file.rename(gsub('processed_data/lines.rds', 'src/json/lines.geojson', tail(.args, 1)), gsub('processed_data/lines.rds', 'src/json/lines.json', tail(.args, 1)))
